...
export function GenerateDialog({ open, format, onChangeFormat, onCancel, onConfirm, employeeName }: GenerateDialogProps) {
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onCancel()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Choisissez le format de génération pour le bulletin de {employeeName}
          </DialogDescription>
        </DialogHeader>
        <div className="py-4">
          <RadioGroup value={format} onValueChange={(value) => onChangeFormat(value as 'pdf' | 'excel')}>
              ...
              <Label htmlFor="pdf" className="flex-1 cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-xs">Document imprimable et portable</div>
                  </div>
                </div>
              </Label>
            </div>
              ...
              <Label htmlFor="excel" className="flex-1 cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-xs">Fichier Excel modifiable</div>
                  </div>
                </div>
              </Label>
            </div>
