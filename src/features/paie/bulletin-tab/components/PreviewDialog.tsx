...
export function PreviewDialog({ open, format, previewUrl, onClose, onDownload, onPrint, employeeName }: PreviewDialogProps) {
  return (
      ...
      <DialogContent className="h-[90vh] max-w-4xl">
        ...
        <div className="flex-1 overflow-hidden">
          {format === 'pdf' && previewUrl ? (
            <iframe src={previewUrl} className="h-[calc(90vh-200px)] w-full rounded-lg border" title="Aperçu du bulletin" />
          ) : (
