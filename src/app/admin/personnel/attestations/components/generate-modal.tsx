    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md" overlayClassName="bg-black/20">
            ...
            <>
              <div className="space-y-2">
                ...
                <DatePickerField
                  ...
                  onChange={(value) => setFormData({ ...formData, stageStartDate: value })}
              ...
              <div className="space-y-2">
                ...
                <DatePickerField
                  ...
                  onChange={(value) => setFormData({ ...formData, stageEndDate: value })}
        ...
        <DialogFooter>
          ...
          <Button onClick={onGenerate}>{t('attestations.actions.generate')}</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
