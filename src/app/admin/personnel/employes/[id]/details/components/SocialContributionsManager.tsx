...
interface Props {
  ...
  mutuellesList?: Array<{
    code: string;
    name: string;
    defaultRates?: { employeePct: number; employerPct: number };
  }>;
}

export default function SocialContributionsManager({
  items = [],
  onAdd,
  onUpdate,
  onDelete,
        ...
        <DialogContent className='max-w-lg'>
          ...
          <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
            ...
            <div className='sm:col-span-2'>
              ...
              <Input
                value={form.watch('affiliationNumber') || ''}
                onChange={(e) =>
                  form.setValue('affiliationNumber', e.target.value)
                }
              />
            </div>
            <div>
              ...
              <Input
                type='number'
                step='0.01'
                value={form.watch('employeeRatePct') ?? ''}
                onChange={(e) =>
                  form.setValue('employeeRatePct', e.target.value as any)
                }
              />
            </div>
            <div>
              ...
              <Input
                type='number'
                step='0.01'
                value={form.watch('employerRatePct') ?? ''}
                onChange={(e) =>
                  form.setValue('employerRatePct', e.target.value as any)
                }
              />
            </div>
            <div>
            ...
            {form.watch('type') === 'Mutuelle' && (
              <div className='sm:col-span-2'>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    form.setValue('providerName', e.target.value)
                  }
